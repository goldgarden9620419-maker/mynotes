...
# 회사 확정 기준(2026-09-18): 국민카드 결제일 15일, 우리·농협카드 23일.
# 이용기간은 카드사 결제일별 공식 표 기준 — 실제 청구서와 다르면
# 기준파일 '카드결제기준' 시트에서 수정한다.
DEFAULT_CARD_RULES = [
    {"카드구분": "국민카드", "카드사": "KB국민카드", "결제일": 15,
     "이용기간 시작일": "전월 2일", "이용기간 종료일": "당월 1일",
     "출금계좌": "국민은행 법인계좌", "사용여부": "사용"},
    {"카드구분": "우리카드", "카드사": "우리카드", "결제일": 23,
     "이용기간 시작일": "전월 10일", "이용기간 종료일": "당월 9일",
     "출금계좌": "우리은행 법인계좌", "사용여부": "사용"},
    {"카드구분": "농협카드", "카드사": "NH농협카드", "결제일": 23,
     "이용기간 시작일": "전월 10일", "이용기간 종료일": "당월 9일",
     "출금계좌": "농협 법인계좌", "사용여부": "사용"},
]
